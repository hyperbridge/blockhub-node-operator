...
describe('ExpressServer', function() {
  describe('method', function() {
    ...
    before(function() {
      p = ExpressServer(undefined, {port: 8000})
    })
    ...
    describe('#_checkKey', function() {
      ...
      it('should accept valid key/ip pairs', function(done) {
        p._checkKey('nodeOperator', 'myip', function(response) {
